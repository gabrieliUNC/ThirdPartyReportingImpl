...
pub fn read(clients: &Vec<constant_mod_priv::Client>, c1c2ad: &Vec<(Vec<u8>, Vec<u8>, (Point, blstrs::G2Affine))>, pks: &Vec<PublicKey>, sigma_st: &Vec<(blstrs::Gt, (Ciphertext, Point, blstrs::G2Affine, Vec<u8>))>) {
